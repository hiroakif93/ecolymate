#' Create a color correspondence table
#' @description Creates a color correspondence table for ggplot2.
#'
#' @param data A matrix or data frame containing samples × abundances.
#' @param color A vector containing color information.
#' @param others Color assigned to non-dominant categories.
#' @param specificName A species name for which a specific color should be assigned (e.g., "Unidentified").
#' @param specificColor Color assigned to the species specified in `specificName`.
#'
#'
#' @examples
#' data(test)
